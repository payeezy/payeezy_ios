...
- (NSDictionary*) constructPurchaseCreditL2L3DirectDebitTransaction:(NSString*)amount
                                                    transactionType:(NSString*)transactionType
                                           merchantRefForProcessing:(NSString*)merchantRefForProcessing
                                                            pMethod:(NSString*)pMethod
                                                       currencyCode:(NSString*)currencyCode
...
- (NSDictionary*)constructPurchaseCreditSoftDescDirectDebitTransaction:(NSString*)totalAmount   transactionType:(NSString*)transactionType merchantRef:(NSString*)merchantRef pMethod:(NSString*)pMethod currencyCode:(NSString*)currencyCode cardtype:(NSString*)cardtype cardHolderName:(NSString*)cardHolderName cardNumber:(NSString*)cardNumber cardExpMMYY:(NSString *)cardExpMMYY cardCVV:(NSString*)cardCVV dbaNameSD:(NSString*)dbaNameSD streetSD:(NSString*)streetSD regionSD:(NSString*)regionSD midSD:(NSString *)midSD mccSD:(NSString*)mccSD postalCodeSD:(NSString*)postalCodeSD countryCodeSD:(NSString*)countryCodeSD  merchantContactInfoSD:(NSString*) merchantContactInfoSD
{
    NSArray *crediCardKeys = @[
                               @"type",
                               @"cardholder_name",
...
/*
 ...
 constructPurchaseCreditSoftDescDirectDebitTransaction:(NSString*)amount
 pMethod:(NSString*)pMethod
 transactiontype:(NSString*)transactiontype
 currencyCode:(NSString*)currencyCode
 
 direct_debit_iban:(NSString*)direct_debit_iban
 direct_debit_mandate_ref:(NSString*)direct_debit_mandate_ref
 direct_debit_bic:(NSString*)direct_debit_bic
 
 soft_descriptors_dba_name:(NSString*)soft_descriptors_dba_name
 soft_descriptors_street:(NSString*)soft_descriptors_street
 soft_descriptors_region:(NSString*)soft_descriptors_region
 soft_descriptors_mid:(NSString*)soft_descriptors_mid
 soft_descriptors_mcc:(NSString*)soft_descriptors_mcc
 soft_descriptors_postal_code:(NSString*)soft_descriptors_postal_code
 soft_descriptors_country_code:(NSString*)soft_descriptors_country_code
 soft_descriptors_merchant_contact_info:(NSString*)soft_descriptors_merchant_contact_info
 */
...
- (NSDictionary*)constructPurchaseCreditSoftDescDirectDebitTransaction:(NSString*)amount
                                                               pMethod:(NSString*)pMethod
                                                       transactiontype:(NSString*)transactiontype
                                                          currencyCode:(NSString*)currencyCode
                                ...
                                soft_descriptors_merchant_contact_info:(NSString*)soft_descriptors_merchant_contact_info
{
    ...
    NSArray *softdescriptorsValues = @[
                                      soft_descriptors_dba_name,
                                      soft_descriptors_street,
                                      soft_descriptors_region,
                                      soft_descriptors_mid,
                                      soft_descriptors_mcc,
                                      soft_descriptors_postal_code,
                                      soft_descriptors_country_code,
                                      soft_descriptors_merchant_contact_info
                                      ];
    
    NSDictionary *softdescriptors_dict = [NSDictionary dictionaryWithObjects:softdescriptorsValues forKeys:softdescriptorsKeys];
    
    NSArray *debitCardKeys = @[
                               @"iban",
                               @"mandate_ref",
                               @"bic"
                               ];
    
    NSArray *debitCardValues = @[
                                 direct_debit_iban,
                                 direct_debit_mandate_ref,
                                 direct_debit_bic
                                 ];
    
    NSDictionary *debitCard_dict = [NSDictionary dictionaryWithObjects:debitCardValues forKeys:debitCardKeys];
...
/**
 Define request structure for Purchase Credit L2L3 DirectDebit Transaction
 @param cardType
 @param cardHolderName
 @param cardNumber
 @param cardExpMMYY
...
- (NSDictionary*)constructPurchaseCreditL2L3DirectDebitTransaction:(NSString*)amount
                                            ...
                                            direct_debit_mandate_ref:(NSString*)direct_debit_mandate_ref
                                                    direct_debit_bic:(NSString*)direct_debit_bic
                                            line_items_description:(NSString*)line_items_description
                                               line_items_quantity:(NSString*)line_items_quantity
                                         line_items_commodity_code:(NSString*)line_items_commodity_code
                                        line_items_discount_amount:(NSString*)line_items_discount_amount
                                     line_items_discount_indicator:(NSString*)line_items_discount_indicator
                                    line_items_gross_net_indicator:(NSString*)line_items_gross_net_indicator
                                        line_items_line_item_total:(NSString*)line_items_line_item_total
                                           line_items_product_code:(NSString*)line_items_product_code
                                             line_items_tax_amount:(NSString*)line_items_tax_amount
                                               line_items_tax_rate:(NSString*)line_items_tax_rate
                                               line_items_tax_type:(NSString*)line_items_tax_type
                                              line_items_unit_cost:(NSString*)line_items_unit_cost
                                        line_items_unit_of_measure:(NSString*)line_items_unit_of_measure


                                              ship_to_address_city:(NSString*)ship_to_address_city
                                             ship_to_address_state:(NSString*)ship_to_address_state
                                               ship_to_address_zip:(NSString*)ship_to_address_zip
                                           ship_to_address_country:(NSString*)ship_to_address_country
                                             ship_to_address_email:(NSString*)ship_to_address_email
                                              ship_to_address_name:(NSString*)ship_to_address_name
                                             ship_to_address_phone:(NSString*)ship_to_address_phone
                                         ship_to_address_address_1:(NSString*)ship_to_address_address_1
                                   ship_to_address_customer_number:(NSString*)ship_to_address_customer_number

                                             level3_alt_tax_amount:(NSString*)level3_alt_tax_amount
                                                 level3_alt_tax_id:(NSString*)level3_alt_tax_id
                                            level3_discount_amount:(NSString*)level3_discount_amount
                                                level3_duty_amount:(NSString*)level3_duty_amount
                                             level3_freight_amount:(NSString*)level3_freight_amount
                                              level3_ship_from_zip:(NSString*)level3_ship_from_zip

                                                level2_tax1_amount:(NSString*)level2_tax1_amount
                                                level2_tax1_number:(NSString*)level2_tax1_number
                                                level2_tax2_amount:(NSString*)level2_tax2_amount
                                                level2_tax2_number:(NSString*)level2_tax2_number
                                               level2_customer_ref:(NSString*)level2_customer_ref
...

{
    ...
    NSArray *lineItemsValues = @[
                                 line_items_description,
                                 line_items_quantity,
                                 line_items_commodity_code,
                                 line_items_discount_amount,
                                 line_items_discount_indicator,
                                 line_items_gross_net_indicator,
                                 line_items_line_item_total,
                                 line_items_product_code,
                                 line_items_tax_amount,
                                 line_items_tax_rate,
                                 line_items_tax_type,
                                 line_items_unit_cost,
                                 line_items_unit_of_measure
                                 ];
    
    NSDictionary *lineItems_dict = [NSDictionary dictionaryWithObjects:lineItemsValues forKeys:lineItemsKeys];
    
    
    NSMutableArray * line_items_Arr = [[NSMutableArray alloc] init];
    
    [line_items_Arr addObject:lineItems_dict];
    
    //ship_to_address
    NSArray *shiptoaddressKeys = @[
                                     @"city",
                                     @"state",
                                     @"zip",
                                     @"country",
    ...
    NSArray *shiptoaddressValues = @[
                                       ...
                                       ship_to_address_address_1,
                                       ship_to_address_customer_number
                                       ];
    
    NSDictionary *shiptoaddress_dict = [NSDictionary dictionaryWithObjects:shiptoaddressValues forKeys:shiptoaddressKeys];
    ...
    NSArray *level3Values = @[
                              level3_alt_tax_amount,
                              level3_alt_tax_id,
                              level3_discount_amount,
                              level3_duty_amount,
                              level3_freight_amount,
                              level3_ship_from_zip,
                              shiptoaddress_dict
                              ];
...
- (NSDictionary*)constructPurchaseCreditAVSDirectDebitTransaction:(NSString*)amount
                                                          pMethod:(NSString*)pMethod
                                                  transactiontype:(NSString*)transactiontype
                                                     currencyCode:(NSString*)currencyCode
                                           ...
                                           direct_debit_mandate_ref:(NSString*)direct_debit_mandate_ref
                                             ...
                                             billing_address_name:(NSString*)billing_address_name
                                             billing_address_city:(NSString*)billing_address_city
                                          billing_address_country:(NSString*)billing_address_country
                                            billing_address_email:(NSString*)billing_address_email
                                       billing_address_phone_type:(NSString*)billing_address_phone_type
                                     billing_address_phone_number:(NSString*)billing_address_phone_number
                                           billing_address_street:(NSString*)billing_address_street
                                   billing_address_state_province:(NSString*)billing_address_state_province
                                  billing_address_zip_postal_code:(NSString*)billing_address_zip_postal_code
{
...
/**
 * PayeezyClient method to process Purchase Credit Transaction With AVS German DirectDebit
 @param amount
 @param transactiontype
 @param pMethod
 @param currencyCode
...
-(void)processPurchaseCreditTransactionWithAVSDirectDebit:(NSString*)amount
                                                  pMethod:(NSString*)pMethod
                                          transactiontype:(NSString*)transactiontype
                                             currencyCode:(NSString*)currencyCode
                                          direct_debit_iban:(NSString*)direct_debit_iban
                          ...
                          billing_address_zip_postal_code:(NSString*)billing_address_zip_postal_code
                          completion:(void (^)(NSDictionary *dict, NSError* error))completion{
    [self postATransactionWithPayload:[self constructPurchaseCreditAVSDirectDebitTransaction:(NSString*)amount
     pMethod:(NSString*)pMethod  transactiontype:(NSString*)transactiontype    currencyCode:(NSString*)currencyCode
     direct_debit_iban:(NSString*)direct_debit_iban  direct_debit_mandate_ref:(NSString*)direct_debit_mandate_ref
     direct_debit_bic:(NSString*)direct_debit_bic  billing_address_name:(NSString*)billing_address_name
     billing_address_city:(NSString*)billing_address_city     billing_address_country:(NSString*)billing_address_country
     billing_address_email:(NSString*)billing_address_email   billing_address_phone_type:(NSString*)billing_address_phone_type  billing_address_phone_number:(NSString*)billing_address_phone_number
      billing_address_street:(NSString*)billing_address_street
        billing_address_state_province:(NSString*)billing_address_state_province
       billing_address_zip_postal_code:(NSString*)billing_address_zip_postal_code ]  completion:^(NSDictionary *dict, NSError *error){
...
/**
 * PayeezyClient method to process Purchase Credit Transaction With SoftDesc DirectDebit
 @param amount
 @param transactiontype
 @param pMethod
 @param currencyCode
...
*/
-(void)processPurchaseCreditTransactionWithSoftDescDirectDebit:(NSString*)amount
                                                       pMethod:(NSString*)pMethod
                                               transactiontype:(NSString*)transactiontype
                                                  currencyCode:(NSString*)currencyCode
                        ...
                        soft_descriptors_merchant_contact_info:(NSString*)soft_descriptors_merchant_contact_info
                                                     completion:(void (^)(NSDictionary *dict, NSError* error))completion{
    [self postATransactionWithPayload:[self constructPurchaseCreditSoftDescDirectDebitTransaction:(NSString*)amount
                                                                                          pMethod:(NSString*)pMethod
                                                                                  transactiontype:(NSString*)transactiontype
                                                                                     currencyCode:(NSString*)currencyCode
                                                                     ...
                                                                     soft_descriptors_postal_code:(NSString*)soft_descriptors_postal_code
                                                                    soft_descriptors_country_code:(NSString*)soft_descriptors_country_code
                                                           soft_descriptors_merchant_contact_info:(NSString*)soft_descriptors_merchant_contact_info ]  completion:^(NSDictionary *dict, NSError *error){
 ...
 */
-(void)processPurchaseCreditTransactionWithL2L3DirectDebit:(NSString*)amount
                                                   pMethod:(NSString*)pMethod
                                           transactiontype:(NSString*)transactiontype
                                              currencyCode:(NSString*)currencyCode
                                    ...
                                    level3_discount_amount:(NSString*)level3_discount_amount
                                     ...
                                     level3_freight_amount:(NSString*)level3_freight_amount
                                      level3_ship_from_zip:(NSString*)level3_ship_from_zip
                                       ...
                                       level2_customer_ref:(NSString*)level2_customer_ref
                                                    completion:(void (^)(NSDictionary *dict, NSError* error))completion{
    [self postATransactionWithPayload:[self constructPurchaseCreditL2L3DirectDebitTransaction:(NSString*)amount
                                                                                      pMethod:(NSString*)pMethod
                                                                              transactiontype:(NSString*)transactiontype
                                                                                 currencyCode:(NSString*)currencyCode
                                                                       ...
                                                                       level3_discount_amount:(NSString*)level3_discount_amount
                                                                        ...
                                                                        level3_freight_amount:(NSString*)level3_freight_amount
                                                                         level3_ship_from_zip:(NSString*)level3_ship_from_zip
                                                                           ...
                                                                           level2_tax2_amount:(NSString*)level2_tax2_amount
                                                                           level2_tax2_number:(NSString*)level2_tax2_number
                                                                          level2_customer_ref:(NSString*)level2_customer_ref ]  completion:^(NSDictionary *dict, NSError *error){
