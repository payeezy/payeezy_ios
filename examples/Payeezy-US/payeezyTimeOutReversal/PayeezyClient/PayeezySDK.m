...
- (NSDictionary*)constructReversalCreditCardPayload:(NSString *)merchantRef  transactionType:(NSString*)transactionType   paymentMethodType:(NSString *)paymentMethodType totalAmount:(NSString *)totalAmount currencyCode:(NSString *)currencyCode reversalId:(NSString *)reversalId
{
    NSArray *payloadKeys = @[
...
-(void)submitReversalTransactionWithCreditCardDetails:(NSString*)merchantRef
    ...
    [self postATransactionWithPayload:[self constructReversalCreditCardPayload:(NSString *)merchantRef    transactionType:(NSString*)transactionType  paymentMethodType:(NSString *)paymentMethodType totalAmount:(NSString *)totalAmount currencyCode:(NSString *)currencyCode   reversalId:(NSString *)reversalId ] completion:^(NSDictionary *dict, NSError *error){
